...
using HCIProjekat.UpravnikView;
...
{
    /// <summary>
    /// Interaction logic for UpravnikNext.xaml
    /// </summary>
    public partial class UpravnikNext : Page
    {
        ...
        private Model.Users.Director Staff;

        private readonly IUserController _userController;
        public UpravnikNext(Staff user)
        {
            Staff = (Model.Users.Director)user;
        ...
        {
            MainWindow.AppWindow.navigateWithTitleChange(new UpravnikPasswordChange(), false);
        }

        private void EditUpravnik_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                dialog.Children.Add(new ConfirmDialog("Izmena naloga", "Da li ste sigurni da zelite da izmenite nalog?",
