...
namespace HealthCare.View.Doctor.Demo
{
    ...
    /// </summary>
    public partial class DrugApprovalEnterOnDrugDemo2 : Window
    {
        ...
        ///////////////////////////////////////////////////////
        public DrugApprovalEnterOnDrugDemo2(Drug drugForAprroval)
        {
            InitializeComponent();
        ...
        private async Task StartDemo(object sender, EventArgs e)
        {
            ...
            lblText.Content = "Izabracemo odbij jer lek nije kompletno unet";
            await Task.Delay(4000);

            btnDrugAprrovalReject.Focus();
            btnDrugAprrovalReject.Background = Brushes.LightBlue;
            await Task.Delay(200);
            if (source.IsCancellationRequested)
            {
                return;
            }
            btnDrugAprrovalReject_Click(sender, e);

        }

        private void btnDrugAprrovalReject_Click(object sender, EventArgs e)
        {
            DrugApprovalRejectReasonDemo window = new DrugApprovalRejectReasonDemo(_drugForApproval);
